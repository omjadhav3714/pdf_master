...
import 'package:pdf_master/screens/pdfShowScreen.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<String> getFolder() async {
    final dir = Directory("storage/emulated/0/PDF Master");
    ...
    return Scaffold(
      appBar: AppBar(
        leading: Padding(
          ...
          child: FaIcon(FontAwesomeIcons.fileAlt,size: 28,),
        ),
        title: Text("Create and Share PDF's"),
        centerTitle: true,
        actions: [
          IconButton(
            onPressed: () async {
                    ...
                    if (stats.type == FileSystemEntityType.file) {
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(
                              "${getFormattedDate(file.lastModifiedSync().toString())}\n" +
                                  fileSize.toStringAsFixed(2) +
                                  " MB"),
                          leading: Icon(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          ...
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => FileNameScreen()));
        },
